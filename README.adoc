https://builds.gbif.org/job/ipt/lastBuild/console[image:https://builds.gbif.org/job/ipt/badge/icon[Build status]] https://crowdin.com/project/gbif-ipt[image:https://badges.crowdin.net/gbif-ipt/localized.svg[Crowdin]]

# Catálogo de Información Biológica - Ceiba

This is a customized version of ipt Gbif version 3.2.1 for the Alexander von Humboldt Institute's Biological Data Catalog tool.
...
[TIP]
====
*Most users should refer to the https://ipt.gbif.org/manual/[user manual] for further information, including https://ipt.gbif.org/manual/en/ipt/latest/releases#3-2-1-december-2025[downloads]
...
* Information on the https://ipt.gbif.org/manual/en/ipt/latest/releases#3-2-1-december-2025[3.2.1 release]
