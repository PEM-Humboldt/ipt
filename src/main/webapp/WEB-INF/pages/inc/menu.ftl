        ...
        <div class="container">
            ...
            [#else]
                 <ul class="navbar-nav me-auto mb-md-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link [#if currentMenu=='faq']active[/#if]" href="https://sites.google.com/humboldt.org.co/i2dwiki/preguntas-frecuentes/faq-ceiba?authuser=0"><img src="${baseURL}/images/icons/about.png">[@s.text name="menu.faq"/]</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link [#if currentMenu=='manual']active[/#if]" href="https://sites.google.com/humboldt.org.co/i2dwiki/ceiba-manual/ceiba-consulta" target="_blank"><img src="${baseURL}/images/icons/usermanu.png">[@s.text name="menu.usermanual"/]</a>
                    </li>
